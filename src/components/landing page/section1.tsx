  ...
  return (
    <section className="relative h-screen">
      ...
      <div className="absolute top-0 left-0 w-full h-full flex flex-col items-center justify-center gap-y-5">
        <h1 className="text-white text-7xl text-center mb-4 font-semibold">
          REAL API Design-first
        </h1>
        <h1 className="text-indigo-400 text-7xl text-center mb-4 font-semibold">
